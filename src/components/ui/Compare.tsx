...
export const Compare = ({
  ...
  return (
    <div
      ref={sliderRef}
      className={cn(
        "size-[300px] sm:size-[200px] md:size-[300px] lg:size-[200px] xl:size-[250px] overflow-hidden select-none",
        className
      )}
      style={{
        position: "relative",
    ...
    >
      ...
      <Image
        src="/empty image.png"
        alt="empty image"
        className="absolute rounded-xl top-0 left-0 z-10 opacity-65"
        layout="fill"
        objectFit="cover"
      />
      <AnimatePresence initial={false}>
