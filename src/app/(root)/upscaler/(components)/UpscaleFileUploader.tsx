...
import { addData } from "@/Redux/reducers/upscaler";
...
export default function UpscaleFileUploader() {
  ...
  async function UpscaleImage() {
    if (files !== null && files.length > 0) {
      ...
      axios
        .post("http://127.0.0.1:8000/upscale_image", formData, {
          headers: {
    ...
    <div className="-mt-24 md:-mt-40 w-full grid place-content-center gap-3">
      ...
      >
        <FileInput className="outline-dashed outline-1 outline-white">
          <div className="w-72 md:w-[40rem] lg:w-[50rem] xl:w-[70rem] h-[30vh] flex items-center justify-center flex-col pt-3 pb-4 gap-2 ">
            <FileSvgDraw />
          </div>
        </FileInput>
        <FileUploaderContent>
